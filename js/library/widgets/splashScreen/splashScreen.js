         ...
         return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
             ...
             */
             postCreate: function () {
                 ...
                 var divCustomButtonText = domConstruct.create("div", { "class": "customButtonInner", "innerHTML": nls.buttons.okButtonText }, this.customButton);
             ...
             showSplashScreenDialog: function () {
                 ...
                 domAttr.set(splashScreenContent, "innerHTML", nls.appSpecific.messages.splashScreenContent);
